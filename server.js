...
• Vitamina A — Retinol (µg RAE): [ingredientes de origen animal]. [función, máximo 15 palabras]
• Vitamina A — Betacaroteno (µg): [ingredientes de origen vegetal]. [función, máximo 15 palabras. Puede mencionarse sinergia con Retinol en el texto si aplica, pero van en líneas separadas]
• Vitamina D2 — Ergocalciferol (µg): [ingredientes: hongos, levaduras]. [función, máximo 15 palabras]
• Vitamina D3 — Colecalciferol (µg): [ingredientes de origen animal]. [función, máximo 15 palabras. Puede mencionarse sinergia con D2 en el texto si aplica, pero van en líneas separadas]
• Vitamina E — Alfa-tocoferol (mg): [ingredientes]. [función, máximo 15 palabras]
• Vitamina E — Gamma-tocoferol (mg): [ingredientes: frutos secos, semillas]. [función, máximo 15 palabras. Puede mencionarse sinergia con alfa-tocoferol en el texto si aplica, pero van en líneas separadas]
• Vitamina K1 — Filoquinona (µg): [ingredientes: vegetales de hoja verde]. [función, máximo 15 palabras]
• Vitamina K2 — Menaquinona MK-4 (µg): [ingredientes: origen animal, yema de huevo, mantequilla]. [función, máximo 15 palabras. Puede mencionarse sinergia con K1 en el texto si aplica, pero van en líneas separadas]
• Vitamina K2 — Menaquinona MK-7 (µg): [ingredientes: fermentados, quesos curados]. [función, máximo 15 palabras]
NOTA: La vitamina K3 (menadiona) es sintética y NO existe en alimentos reales. Nunca mencionarla.

**Vitaminas hidrosolubles**

Listar cada una por separado en su propia viñeta, solo si tiene fuente real en los ingredientes:
• Vitamina C — Ácido ascórbico (mg): [ingredientes]. [función, máximo 15 palabras]
• Vitamina B1 — Tiamina (mg): [ingredientes]. [función, máximo 15 palabras]
• Vitamina B2 — Riboflavina (mg): [ingredientes]. [función, máximo 15 palabras]
• Vitamina B3 — Niacina (mg NE): [ingredientes]. [función, máximo 15 palabras]
• Vitamina B5 — Ácido pantoténico (mg): [ingredientes]. [función, máximo 15 palabras]
• Vitamina B6 — Piridoxina (mg): [ingredientes]. [función, máximo 15 palabras]
• Vitamina B7 — Biotina (µg): [ingredientes]. [función, máximo 15 palabras]
• Vitamina B9 — Folato natural (µg DFE): [ingredientes]. [función, máximo 15 palabras]
• Vitamina B9 — Ácido fólico sintético (µg): [solo si hay alimentos fortificados en el día]. [función]
• Vitamina B12 — Cobalamina (µg): [ingredientes, especificar si es cianocobalamina o metilcobalamina según la fuente]. [función, máximo 15 palabras]
...
• Calcio (mg): [ingredientes]. [función, máximo 15 palabras]
• Fósforo (mg): [ingredientes]. [función, máximo 15 palabras]
• Magnesio (mg): [ingredientes]. [función, máximo 15 palabras]
• Sodio (mg): [ingredientes]. [función, máximo 15 palabras]
• Potasio (mg): [ingredientes]. [función, máximo 15 palabras]
• Cloro (mg): [ingredientes]. [función, máximo 15 palabras]
• Azufre (mg): [ingredientes: huevo, carne, col, ajo, cebolla]. [función, máximo 15 palabras]
...
• Hierro hemo (mg): [ingredientes de origen animal exclusivamente]. [función + nota de alta biodisponibilidad, máximo 15 palabras]
• Hierro no hemo (mg): [ingredientes de origen vegetal exclusivamente]. [función + nota de menor biodisponibilidad, máximo 15 palabras]
• Zinc (mg): [ingredientes]. [función, máximo 15 palabras]
• Cobre (mg): [ingredientes]. [función, máximo 15 palabras]
• Manganeso (mg): [ingredientes]. [función, máximo 15 palabras]
• Selenio (µg): [ingredientes]. [función, máximo 15 palabras]
• Yodo (µg): [ingredientes]. [función, máximo 15 palabras]
• Cromo (µg): [ingredientes]. [función, máximo 15 palabras]
• Molibdeno (µg): [ingredientes]. [función, máximo 15 palabras]
• Flúor (mg): [ingredientes]. [función, máximo 15 palabras]
...
• Grasas monoinsaturadas — MUFAs / Ácido oleico (g): [ingredientes: aceite de oliva, aguacate, frutos secos]. [función, máximo 15 palabras]
• Grasas saturadas — SFAs (g): [ingredientes: mantequilla, carne, coco]. [función, máximo 15 palabras]
• Triglicéridos de cadena media — MCT (g): [ingredientes: aceite de coco, mantequilla]. [función cetogénica específica, máximo 15 palabras]
• Omega-3 — ALA / Ácido alfa-linolénico (g): [ingredientes vegetales: semillas de lino, chía, nueces]. [función, máximo 15 palabras]
• Omega-3 — EPA / Ácido eicosapentaenoico (g): [ingredientes animales: pescado azul]. [función antiinflamatoria, máximo 15 palabras]
• Omega-3 — DHA / Ácido docosahexaenoico (g): [ingredientes animales: pescado azul, huevo enriquecido]. [función cerebral y visual, máximo 15 palabras]
• Omega-6 — Ácido linoleico (g): [ingredientes: frutos secos, semillas, aceites vegetales]. [función, máximo 15 palabras]
...
• Fibra soluble (g): [ingredientes]. Ralentiza la absorción de glucosa; base fermentable para la microbiota.
• Fibra insoluble (g): [ingredientes: celulosa, hemicelulosas, lignina]. Regula el tránsito intestinal; no fermentable.
• Pectinas / mucílagos / gomas (g): [ingredientes: frutas, semillas como chía y lino]. Forman gel en el intestino; efecto saciante y prebiótico.
• Inulina / FOS / GOS (g): [ingredientes: cebolla, ajo, puerro, espárragos, alcachofa]. Prebiótico específico; estimula bifidobacterias.
• Almidón resistente (g): [ingredientes: legumbres cocinadas y enfriadas, plátano verde si aplica]. Fermentación colónica; producción de butirato.
• Beta-glucanos (g): [ingredientes: semillas, algunos vegetales]. Modulan respuesta glucémica e inmune.
• Quitina vegetal (g): [ingredientes: hongos exclusivamente]. Solo incluir si hay hongos en el día.
