...
10. TONO Y LENGUAJE — REGLA CRÍTICA: Este libro está escrito para adultos sin formación sanitaria: principiantes en cetogénica, deportistas y personas con objetivos de salud general. Redacta como si le explicaras algo a un amigo inteligente pero sin estudios de nutrición. Cada función de vitaminas, minerales y compuestos debe describirse en términos de lo que hace en el cuerpo, no en términos bioquímicos. Ejemplo correcto: "ayuda a mantener los huesos fuertes y regula la contracción muscular". Ejemplo incorrecto: "cofactor en la cascada de coagulación y la carboxilación de proteínas".
11. SIGLAS — REGLA ABSOLUTA: Prohibido usar siglas sin desarrollar su significado. Las siguientes siglas están terminantemente prohibidas en su forma abreviada: ATP, SOD, MnSOD, FAD, NFκB, Nrf2, MCT, ALA, EPA, DHA, LDL, HDL, T3, T4, FOS, GOS, CLA, MUFAs, SFAs, PUFAs, RAE, NE, DFE, CoA. Si el concepto es necesario, escribe en lenguaje cotidiano lo que hace. Ejemplo correcto: "los triglicéridos de cadena media, una grasa que el hígado transforma en energía rápidamente". Ejemplo incorrecto: "MCT".
12. UNIDADES DE MEDIDA — REGLA ABSOLUTA: No incluir unidades de medida (mg, µg, g, RAE, NE, DFE, etc.) en los nombres de vitaminas, minerales ni ningún otro nutriente. El lector no tiene referencia para esas cifras y generan confusión. Correcto: "Vitamina B3 (Niacina)". Incorrecto: "Vitamina B3 (Niacina) (mg NE)".
13. FORMATO DE NOMBRES — REGLA ABSOLUTA: Los nombres de vitaminas, minerales y tipos de grasa usan siempre paréntesis, nunca guión largo. Correcto: "Vitamina K1 (Filoquinona)". Incorrecto: "Vitamina K1 — Filoquinona". Correcto: "Grasas monoinsaturadas (ácido oleico)". Incorrecto: "Grasas monoinsaturadas — MUFAs / Ácido oleico".
14. Cada balance debe ser único. La introducción y la conclusión deben redactarse con vocabulario, estructura de frases y enfoque distintos a los de cualquier otro día. Prohibido reutilizar frases, expresiones o estructuras de apertura y cierre entre días.
...
REGLA ABSOLUTA DE VITAMINAS: Cada vitamina y cada subtipo se lista en su propia línea independiente. Nunca agrupar varios subtipos en una sola viñeta. Nunca escribir "Vitamina K (K1 y K2)" ni "Vitamina D (D2/D3)" ni ninguna otra combinación. Cada uno va solo en su línea. Solo incluir los que tienen fuente real en los ingredientes del día.

**Vitaminas liposolubles**

Listar cada una por separado en su propia viñeta, solo si tiene fuente real en los ingredientes:
• Vitamina A (Retinol): [ingredientes de origen animal]. [función, máximo 15 palabras]
• Vitamina A (Betacaroteno): [ingredientes de origen vegetal]. [función, máximo 15 palabras. Puede mencionarse sinergia con Retinol en el texto si aplica, pero van en líneas separadas]
• Vitamina D2 (Ergocalciferol): [ingredientes: hongos, levaduras]. [función, máximo 15 palabras]
• Vitamina D3 (Colecalciferol): [ingredientes de origen animal]. [función, máximo 15 palabras. Puede mencionarse sinergia con D2 en el texto si aplica, pero van en líneas separadas]
• Vitamina E (Alfa-tocoferol): [ingredientes]. [función, máximo 15 palabras]
• Vitamina E (Gamma-tocoferol): [ingredientes: frutos secos, semillas]. [función, máximo 15 palabras. Puede mencionarse sinergia con alfa-tocoferol en el texto si aplica, pero van en líneas separadas]
• Vitamina K1 (Filoquinona): [ingredientes: vegetales de hoja verde]. [función, máximo 15 palabras]
• Vitamina K2 (Menaquinona MK-4): [ingredientes: origen animal, yema de huevo, mantequilla]. [función, máximo 15 palabras. Puede mencionarse sinergia con K1 en el texto si aplica, pero van en líneas separadas]
• Vitamina K2 (Menaquinona MK-7): [ingredientes: fermentados, quesos curados]. [función, máximo 15 palabras]
NOTA: La vitamina K3 (menadiona) es sintética y NO existe en alimentos reales. Nunca mencionarla.

**Vitaminas hidrosolubles**

Listar cada una por separado en su propia viñeta, solo si tiene fuente real en los ingredientes:
• Vitamina C (Ácido ascórbico): [ingredientes]. [función, máximo 15 palabras]
• Vitamina B1 (Tiamina): [ingredientes]. [función, máximo 15 palabras]
• Vitamina B2 (Riboflavina): [ingredientes]. [función, máximo 15 palabras]
• Vitamina B3 (Niacina): [ingredientes]. [función, máximo 15 palabras]
• Vitamina B5 (Ácido pantoténico): [ingredientes]. [función, máximo 15 palabras]
• Vitamina B6 (Piridoxina): [ingredientes]. [función, máximo 15 palabras]
• Vitamina B7 (Biotina): [ingredientes]. [función, máximo 15 palabras]
• Vitamina B9 (Folato natural): [ingredientes]. [función, máximo 15 palabras]
• Vitamina B9 (Ácido fólico sintético): [solo si hay alimentos fortificados en el día]. [función]
• Vitamina B12 (Cobalamina): [ingredientes, especificar si es cianocobalamina o metilcobalamina según la fuente]. [función, máximo 15 palabras]

**Minerales**

REGLA ABSOLUTA DE MINERALES: Cada mineral se lista en su propia línea independiente. Nunca agrupar. Solo incluir los que tienen fuente real en los ingredientes del día.

**Macrominerales**

Listar cada uno por separado en su propia viñeta, solo si tiene fuente real en los ingredientes:
• Calcio: [ingredientes]. [función, máximo 15 palabras]
• Fósforo: [ingredientes]. [función, máximo 15 palabras]
• Magnesio: [ingredientes]. [función, máximo 15 palabras]
• Sodio: [ingredientes]. [función, máximo 15 palabras]
• Potasio: [ingredientes]. [función, máximo 15 palabras]
• Cloro: [ingredientes]. [función, máximo 15 palabras]
• Azufre: [ingredientes: huevo, carne, col, ajo, cebolla]. [función, máximo 15 palabras]

**Oligoelementos**

Listar cada uno por separado en su propia viñeta, solo si tiene fuente real en los ingredientes. El hierro SIEMPRE se separa por forma:
• Hierro hemo: [ingredientes de origen animal exclusivamente]. [función + nota de alta biodisponibilidad, máximo 15 palabras]
• Hierro no hemo: [ingredientes de origen vegetal exclusivamente]. [función + nota de menor biodisponibilidad, máximo 15 palabras]
• Zinc: [ingredientes]. [función, máximo 15 palabras]
• Cobre: [ingredientes]. [función, máximo 15 palabras]
• Manganeso: [ingredientes]. [función, máximo 15 palabras]
• Selenio: [ingredientes]. [función, máximo 15 palabras]
• Yodo: [ingredientes]. [función, máximo 15 palabras]
• Cromo: [ingredientes]. [función, máximo 15 palabras]
• Molibdeno: [ingredientes]. [función, máximo 15 palabras]
• Flúor: [ingredientes]. [función, máximo 15 palabras]

**El valor añadido plus de calidad**

**Grasas saludables y perfil lipídico**

REGLA ABSOLUTA DE GRASAS: Cada tipo y subtipo se lista en su propia línea independiente. Nunca agrupar. Solo incluir los que tienen fuente real en los ingredientes del día.

• Grasas monoinsaturadas (ácido oleico): [ingredientes: aceite de oliva, aguacate, frutos secos]. [función, máximo 15 palabras]
• Grasas saturadas: [ingredientes: mantequilla, carne, coco]. [función, máximo 15 palabras]
• Triglicéridos de cadena media: [ingredientes: aceite de coco, mantequilla]. [función cetogénica específica, máximo 15 palabras]
• Omega-3 (ácido alfa-linolénico, vegetal): [ingredientes vegetales: semillas de lino, chía, nueces]. [función, máximo 15 palabras]
• Omega-3 (ácido eicosapentaenoico, marino): [ingredientes animales: pescado azul]. [función antiinflamatoria, máximo 15 palabras]
• Omega-3 (ácido docosahexaenoico, marino): [ingredientes animales: pescado azul, huevo enriquecido]. [función cerebral y visual, máximo 15 palabras]
• Omega-6 (ácido linoleico): [ingredientes: frutos secos, semillas, aceites vegetales]. [función, máximo 15 palabras]

**Fibra vegetal**

REGLA ABSOLUTA DE FIBRA: Cada subtipo de fibra se lista en su propia línea independiente. Nunca agrupar varios subtipos en una sola viñeta. Solo incluir los que tienen fuente real en los ingredientes del día.

• Fibra soluble: [ingredientes]. Ralentiza la absorción de glucosa; base fermentable para la microbiota.
• Fibra insoluble: [ingredientes: celulosa, hemicelulosas, lignina]. Regula el tránsito intestinal; no fermentable.
• Pectinas, mucílagos y gomas: [ingredientes: frutas, semillas como chía y lino]. Forman gel en el intestino; efecto saciante y prebiótico.
• Inulina y fibras prebióticas: [ingredientes: cebolla, ajo, puerro, espárragos, alcachofa]. Prebiótico específico; estimula bifidobacterias.
• Almidón resistente: [ingredientes: legumbres cocinadas y enfriadas, plátano verde si aplica]. Fermentación colónica; producción de butirato.
• Beta-glucanos: [ingredientes: semillas, algunos vegetales]. Modulan respuesta glucémica e inmune.
• Quitina vegetal: [ingredientes: hongos exclusivamente]. Solo incluir si hay hongos en el día.
